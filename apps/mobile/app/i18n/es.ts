...
const es: ENTranslations = {
  ...
  newPatient: {
    ...
    uniqueFieldTaken: "Este valor ya está en uso por otro paciente",
    uniqueFieldsTaken: "Los siguientes campos deben ser únicos pero ya existen para otro paciente: {{fields}}",
  ...
  diagnosisSearch: {
    ...
    createCustom: "+ Crear \"{{query}}\"",
    noResults: "No se encontraron resultados. Puede crear un diagnóstico personalizado arriba.",
    noPermission: "No tiene permiso para crear diagnósticos",
    saveError: "Error al guardar el diagnóstico. Por favor, inténtelo de nuevo.",
    removeEndDate: "Eliminar Fecha de Fin",
    addEndDate: "+ Agregar Fecha de Fin",
  },
  diagnosisEditor: {
    title: "Editar Diagnóstico",
    loadError: "No se pudo cargar el diagnóstico.",
    noPermission: "No tiene permiso para editar diagnósticos",
    validationError: "Error de Validación",
    severityRange: "La puntuación de gravedad debe estar entre 1 y 10.",
    saveError: "Error al actualizar el diagnóstico. Por favor, inténtelo de nuevo.",
    clinicalStatus: "Estado Clínico",
    verificationStatus: "Estado de Verificación",
    severityScore: "Puntuación de Gravedad (1-10)",
    optional: "Opcional",
    onsetDate: "Fecha de Inicio",
    removeResolvedDate: "Eliminar Fecha de Resolución",
    addResolvedDate: "+ Agregar Fecha de Resolución",
    active: "Activo",
    remission: "Remisión",
    resolved: "Resuelto",
    unknown: "Desconocido",
