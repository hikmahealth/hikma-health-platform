...
const ar: Translations = {
  ...
  newPatient: {
    ...
    uniqueFieldTaken: "هذه القيمة مستخدمة بالفعل لمريض آخر",
    uniqueFieldsTaken: "يجب أن تكون الحقول التالية فريدة ولكنها موجودة بالفعل لمريض آخر: {{fields}}",
    errorSaving: "حدث خطأ أثناء حفظ سجل المريض",
    successfulSave: "تم حفظ سجل المريض بنجاح",
    done: "تم",
    requiredFieldsMissing: "يرجى ملء الحقول المطلوبة التالية: {{fields}}",
  },
  summaryStats: {
  ...
  settingsScreen: {
    ...
    onlineModeUnavailable: "الوضع المتصل غير متاح في هذا الإصدار",
  ...
  diagnosisSearch: {
    ...
    createCustom: "+ إنشاء \"{{query}}\"",
    noResults: "لم يتم العثور على نتائج. يمكنك إنشاء تشخيص مخصص أعلاه.",
    noPermission: "ليس لديك إذن لإنشاء التشخيصات",
    saveError: "فشل حفظ التشخيص. يرجى المحاولة مرة أخرى.",
    removeEndDate: "إزالة تاريخ الانتهاء",
    addEndDate: "+ إضافة تاريخ انتهاء",
  },
  diagnosisEditor: {
    title: "تعديل التشخيص",
    loadError: "تعذر تحميل التشخيص.",
    noPermission: "ليس لديك إذن لتعديل التشخيصات",
    validationError: "خطأ في التحقق",
    severityRange: "يجب أن تكون درجة الخطورة بين 1 و 10.",
    saveError: "فشل تحديث التشخيص. يرجى المحاولة مرة أخرى.",
    clinicalStatus: "الحالة السريرية",
    verificationStatus: "حالة التحقق",
    severityScore: "درجة الخطورة (1-10)",
    optional: "اختياري",
    onsetDate: "تاريخ البداية",
    removeResolvedDate: "إزالة تاريخ الشفاء",
    addResolvedDate: "+ إضافة تاريخ شفاء الحالة",
    active: "نشط",
    remission: "هدأة",
    resolved: "تم الشفاء",
    unknown: "غير معروف",
  ...
  syncSettingsScreen: {
    ...
    confirmSetDefaultDescription: "هل أنت متأكد أنك تريد تعيين هذا الجهاز كجهاز الافتراضي؟",
