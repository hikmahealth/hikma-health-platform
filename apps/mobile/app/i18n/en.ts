const en = {
  ...
  newPatient: {
    ...
    uniqueFieldTaken: "This value is already used by another patient",
    uniqueFieldsTaken: "The following fields must be unique but already exist for another patient: {{fields}}",
